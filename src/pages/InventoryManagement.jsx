...
import { Download, Filter, TrendingDown, TrendingUp, BarChart } from 'lucide-react';
...
const InventoryManagement = () => {
  ...
  const [flowFilters, setFlowFilters] = useState({ startDate: '', endDate: '', type: 'ALL', usageType: 'ALL', entity: 'ALL' });
  ...
  const renderAdvancedFilters = (filteredTxns) => {
    return (
  ...
  const renderAnalytics = () => {
    ...
    return (
      <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        {renderAdvancedFilters(filteredTxns)}
  ...
  return (
    <div className="animate-fade-in" style={{ paddingBottom: '3rem' }}>
      ...
      <div className="tabs-container" style={{ marginBottom: '2rem' }}>
        ...
        <button className={`tab ${activeTab === 'Analytics & Flow' ? 'active' : ''}`} onClick={() => { setActiveTab('Analytics & Flow'); setSearchQuery(''); }} style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
          <LineChart size={14} /> Analytics & Flow
        </button>
      </div>

      {activeTab === 'Overview' && renderGlobalOverview()}
      {activeTab === 'Settings' && renderSettings()}
      {activeTab === 'Analytics & Flow' && renderAnalytics()}
      {activeTab !== 'Overview' && activeTab !== 'Settings' && activeTab !== 'Analytics & Flow' && renderLocationView(activeTab)}
